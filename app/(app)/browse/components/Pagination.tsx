...
const BUTTON_CLASS =
  "flex h-8 min-w-8 items-center justify-center rounded-md border border-border px-2.5 text-xs font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30";
  ...
  return (
    ...
    >
      <Link
        ...
        className={`${BUTTON_CLASS} gap-1 bg-white text-muted ${
          page === 1
          ...
          <Link
            ...
            className={`${BUTTON_CLASS} ${
              entry === page
                ...
                : "bg-white text-muted hover:border-ink/20 hover:text-ink"
            }`}
          >
            {entry}
          </Link>
